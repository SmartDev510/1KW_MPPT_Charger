/*******************************************************************************
   Convert Albanian
   Albanian Characters on a standard HD44780 LCD
...
void customCharacterMapping_sq()
{
  //  This UTF8 code will become  -->   that custom character
  utf8_to_customChar[4] = 0xC387;    lcd.createChar_P(4, latin_capital_c_cedilla);       // Ç
  utf8_to_customChar[5] = 0xC3A7;    lcd.createChar_P(5, latin_small_c_cedilla);         // ç
  utf8_to_customChar[6] = 0xC38B;    lcd.createChar_P(6, latin_capital_e_diaresis);      // Ë
  utf8_to_customChar[7] = 0xC3AB;    lcd.createChar_P(7, latin_small_e_diaresis);        // ë       
}
...
void setup()
{
  ...
  lcd.backlight();
  customCharacterMapping_sq();
  
  lcd.setCursor(0, 0);
  lcd.print("Shqip - Albanian");
  lcd.setCursor(0, 1);
  lcd.print("Ç ç Ë ë -3°C");
}
