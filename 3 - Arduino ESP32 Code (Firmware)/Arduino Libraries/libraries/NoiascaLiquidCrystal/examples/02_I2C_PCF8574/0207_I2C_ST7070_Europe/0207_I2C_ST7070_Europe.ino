/*
   ...
   Important: The presentation of these special characters will only work with the ST7070 IC.
              It will not be complete with displays based on HD44780!
...
LiquidCrystal_I2C_ST7070_Ext lcd(addr, cols, rows);     // this is for displays with ST7070 driver with extended special character support Latin-1, -2, -3, -4
//LiquidCrystal_I2C_ST7070 lcd(addr, cols, rows);       // this is for displays with ST7070 driver, it handles only some characters from Latin-1
...
Content content[] = {
  ...
  {"cs", "Dobrý večer", "áčďéěíňóřšťúůýž"},                // Czech
  ...
  {"sv", "Hallå", "Å å Ä ä Ö ö"},                          // Swedish
  {"sk", "Dobré ráno", "áäčďéíĺľňóôŕšťúýž"}, 
  {"sl", "Dobro jutro", "č š ž Č Š Ž"},
  {"sq", "Albania", "Ç ç Ë ë"},                            // Albanian
